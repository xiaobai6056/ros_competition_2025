...
private:
    ...
    void moveToNextRoom();
    void stopMoving();
    bool handleTask(test_pkg::Service::Request  &req, test_pkg::Service::Response &res);
    ...
    // 开始指令回调
    void startCallback(const std::string msg);
    ...
    // 服务服务端
    ros::ServiceServer task_service_server_;
